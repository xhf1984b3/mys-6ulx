...
#ifdef CONFIG_OF
static const struct of_device_id epson_rtc8010_of_match[] = {
	{ .compatible = "epson,rx8010", },

};
MODULE_DEVICE_TABLE(of, epson_rtc8010_of_match);
#endif
static struct i2c_driver rx8010_driver = {
	.driver = {
		.name = "rtc-rx8010",
		.owner = THIS_MODULE,
                .of_match_table = of_match_ptr(epson_rtc8010_of_match),
	},
	.probe		= rx8010_probe,
